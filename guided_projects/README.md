...
2. `adk create $agent` prompts to choose a backend — went with **Vertex AI** over 
...
3. GCP Organization is a separate entity — a new domain is required to create one.
...
4. To create a folder, the `resourcemanager.folders.create` permission is needed on the org.
...
|---|---|
| `hello_agent` | ADK basics, project setup, venv |
| `sequential_agent_deployed` | Sequential agents, state sharing, Cloud Run |